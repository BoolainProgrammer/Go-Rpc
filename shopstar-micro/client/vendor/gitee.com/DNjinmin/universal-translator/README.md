...
该组件整体还是go-playground/universal-translator组件的功能及内容；主要对该组件中的异常输出做微调；
...
表单提交后展示的错误信息,注意看password，会含有password字段名；

![](assets/1.png)

修改之后效果如下：

![](assets/markdown-img-paste-20220114002118997.png)
